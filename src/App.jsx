  ...
  return (
    <div style={S.header}>
      <div style={S.brand}>
        ...
        <span style={S.brandName}>ProcessFirst</span>
      </div>
      <div style={S.steps}>
        {labels.map((l, i) => {
...
const S = {
  ...
  brandMark: { width: 16, height: 16, borderRadius: 4, background: VERM, transform: "rotate(45deg)", display: "inline-block" },
  brandName: { fontWeight: 700, letterSpacing: "-0.01em", color: NAVY, fontSize: 16 },
